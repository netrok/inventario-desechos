    ...
    <div class="py-6">
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between gap-3 mb-5">
                <div>
                    <h1 class="text-xl font-semibold text-gray-900">Editar cliente — {{ $cliente->codigo }}</h1>
                    <p class="text-sm text-gray-500">Los cambios no alteran las ventas históricas (usan snapshot).</p>
                </div>
