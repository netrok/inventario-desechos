...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas contienen mensajes por defecto utilizados por el
    | validador. Se usan cuando el atributo (p. ej. "nombre") no puede
    | transformarse automáticamente, por lo que incluimos también sustitución
    | para "attribute" independientemente del atributo real.
    |
    */
    ...
    'missing' => 'El campo :attribute no debe existir.',
    'missing_if' => 'El campo :attribute no debe existir cuando :other es :value.',
    'missing_unless' => 'El campo :attribute no debe existir a menos que :other sea :value.',
    'missing_with' => 'El campo :attribute no debe existir cuando :values esté presente.',
    'missing_with_all' => 'El campo :attribute no debe existir cuando :values estén presentes.',
    ...
    'password' => [
        ...
        'uncompromised' => 'La contraseña aparece en una fuga de datos y no debe usarse.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Podemos especificar mensajes personalizados para atributos con la regla
    | "rule.attribute". Las convenciones de nomenclatura son:
    |
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas reemplazan los nombres de los atributos para que
    | los mensajes se lean de forma más natural.
    |
    */
